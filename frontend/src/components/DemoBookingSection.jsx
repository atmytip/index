...
export default function DemoBookingSection() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.name || !formData.email || !formData.company || !formData.employees || !formData.phone) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <div className="flex justify-center -mb-12">
            <img
              ...
              className="w-44 md:w-56 h-auto drop-shadow-lg mr-32"
            />
          </div>
        ...
        <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-stretch">
          ...
          <div className="lg:col-span-2">
            <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-8 text-white relative overflow-hidden h-full">
              {/* Decorative elements */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col">
                    <Label htmlFor="message" className="text-slate-700 font-semibold text-sm">
                      Is there a specific 'headache' you want us to solve first?
                    </Label>
                    <Textarea
                      id="message"
                      name="message"
